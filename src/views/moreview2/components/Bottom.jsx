    ...
    <>
      <Box className="bottom">
        <Box className="desc">
          ...
          <Text>
            Lil Pudgys are a collection of 22,222 randomly generated NFTs minted
            on Ethereum.
          </Text>
        </Box>
        <Box className="list">
        ...
        <Box className="royalties">
          ...
          <Text mb={"8px"}>
            Split royalties are automatically deposited into each recipient's
            wallet
          </Text>
          <Flex
            border={"1px solid"}
        ...
        <Box className="details">
          ...
          <Box
            ...
            p={"20px"}
          >
            <List mb={"10px"} display={"flex"} flexDir={"column"} gap={"5px"}>
            ...
            <List pt={"15px"} borderTop={"1px solid"} borderColor={"tab.200"}>
              <ChakraLink as={ChakraLink} to={"/morview2"}>
                <ListItem display={"flex"} alignItems={"center"} gap={"15px"}>
                  <Img src={f5} alt="/" />
                  Refresh Metadata
                </ListItem>
              </ChakraLink>
